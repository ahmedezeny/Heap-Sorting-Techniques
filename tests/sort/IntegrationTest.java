...
public class IntegrationTest
{
  ...
  @Test
  public void testCreationHeap() { List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.sort.ReflectionHelper.findClassesImplementing(heapInterfaceToTest, heapInterfaceToTest.getPackage());
  ...
  public void testCreationSort() {
    List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.sort.ReflectionHelper.findClassesImplementing(sortInterfaceToTest, sortInterfaceToTest.getPackage());
